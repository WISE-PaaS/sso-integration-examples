...
import org.iii.sso.classDefinition.EINameTemplate;
import org.iii.sso.classDefinition.LoginRes;
import org.iii.sso.classDefinition.PCFUtil;
import org.iii.sso.classDefinition.PatchUserRes;
import org.iii.sso.classDefinition.ResponseCookie;
import org.iii.sso.classDefinition.User;
import org.iii.sso.db.PostgreSql;
...
public class ssoService {
	...
	public ObjectNode getSRPToken(String srpToken, String endPointUrl) {
...
//					String orgId = "64ebfa4b-454e-4db3-8f91-7db3e169a962";
	...
	public ObjectNode getValidateToken(String EIToken) throws IOException {
		ObjectMapper mapp = new ObjectMapper();
		ObjectNode json = mapp.createObjectNode();
		json.put("token", EIToken);
